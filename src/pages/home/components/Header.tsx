...
const Header: FC = () => {
    return (
        <header className="
             ...
             items-center
             flex-col
             font-[family-name:var(--body-font)]

         ">
            <div className="px-5 pb-6 flex justify-center gap-5 flex-col fa-1 lg:w-4/6  text-white">
                <h1 className="font-[family-name:var(--header-font)] text-heading-1-mobile md:text-6xl text-center ">Olá, eu sou <br
                    className="md:hidden"/> Vinícius
                    Goulart</h1>
                <h2 className=" text-[1rem] text-center md:text-xl">Engenheiro de Computação em
