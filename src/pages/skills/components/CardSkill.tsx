...
const CardSkill: React.FC<CardSkillProps> = ({icon, title, level, tag, description}) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-6 transition-transform hover:scale-105 font-cantarell
      text-text-mobile md:text-text-desktop cursor-pointer">
            <div className="flex flex-col items-center">
                <div
                    className="text-3xl bg-amber-400 mb-3 p-4 w-18 h-18 flex justify-center items-center  rounded-full">
                    <FontAwesomeIcon icon={icon}/>
                </div>


                <h3 className="text-xl font-semibold mb-2 font-sen text-heading-4-mobile md:text-heading-4-desktop">
                    {title}
                </h3>
